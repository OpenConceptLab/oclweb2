...
const ConceptHomeDetails = ({ concept, isLoadingMappings, isLoadingCollections, source, childConcepts, parentConcepts, isLoadingChildren, isLoadingParents, singleColumn, versions, scoped, sourceVersion, parent }) => {
  ...
  return (
    <div className='row' style={{width: '100%', margin: 0}}>
      ...
      <div className={classes} style={{paddingTop: '10px'}}>
        <HomeMappings concept={concept} isLoadingMappings={isLoadingMappings} childConcepts={childConcepts} parentConcepts={parentConcepts} isLoadingChildren={isLoadingChildren} isLoadingParents={isLoadingParents} source={source} sourceVersion={sourceVersion} parent={parent} />
        {
          scoped === 'collection' ?
            <ResourceReferences
              resource='concept'
