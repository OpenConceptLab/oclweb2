  ...
  concepts: [
    {
      ...
      sortOn: "owner",
      renderer: (concept) => (
        <OwnerChip ownerType={concept.owner_type} owner={concept.owner} />
      ),
      essential: false,
    },
    {
    ...
    { id: "id", label: "ID", value: "id", sortOn: "id", className: "small" },
    {
      ...
      value: "display_name",
      sortOn: "_name",
      renderer: (concept) => <ConceptDisplayName concept={concept} />,
      className: "medium",
      sortBy: "asc",
      tooltip:
  ...
  mappings: [
    {
      ...
      sortOn: "owner",
      renderer: (mapping) => (
        <OwnerChip ownerType={mapping.owner_type} owner={mapping.owner} />
      ),
      essential: false,
    },
    {
    ...
    { id: "id", label: "ID", value: "id", sortOn: "id", className: "small" },
    {
      ...
      label: "From Concept",
      renderer: (mapping) => (
        <FromConceptLabelVertical {...mapping} noRedirect />
      ),
      className: "medium",
    },
    {
    ...
    },
    {
      id: "to",
      label: "To Concept",
      renderer: (mapping) => <ToConceptLabelVertical {...mapping} noRedirect />,
      className: "medium",
    },
    {
      id: "updatedOn",
  ...
  sources: [
    {
      ...
      sortOn: "owner",
      renderer: (source) => (
        <OwnerChip ownerType={source.owner_type} owner={source.owner} />
      ),
      essential: false,
    },
  ...
  collections: [
    {
      ...
      sortOn: "owner",
      renderer: (coll) => (
        <OwnerChip ownerType={coll.owner_type} owner={coll.owner} />
      ),
      essential: false,
    },
    { id: "id", label: "ID", value: "short_code", sortOn: "mnemonic" },
  ...
  organizations: [
    {
      ...
      value: "id",
      sortOn: "mnemonic",
      renderer: (org) => <OwnerChip ownerType="Organization" owner={org.id} />,
    },
    { id: "name", label: "Name", value: "name", sortOn: "name", sortBy: "asc" },
    {
      id: "createdOn",
  ...
  users: [
    {
      ...
      value: "username",
      sortOn: "username",
      renderer: (user) => <OwnerChip ownerType="user" owner={user.username} />,
      sortBy: "asc",
    },
    { id: "name", label: "Name", value: "name", sortOn: "name", sortBy: "asc" },
    {
  ...
  references: [
    {
      ...
      value: "expression",
      sortable: false,
      renderer: (reference) => <ReferenceChip {...reference} />,
    },
  ],
  CodeSystem: [
    {
    ...
    },
    {
      ...
      value: "resource.name",
      renderer: (codeSystem) => (
        <span className={codeSystem.resource.status}>
